...
function fillCategory() {
    ...
    addOption(document.drop_list.State, "Abia", "Abia", "");
    addOption(document.drop_list.State, "Adamawa", "Adamawa", "");
    addOption(document.drop_list.State, "Akwa Ibom", "Akwa Ibom", "");
    addOption(document.drop_list.State, "Anambra", "Anambra", "");
    addOption(document.drop_list.State, "Bauchi", "Bauchi", "");
    addOption(document.drop_list.State, "Bayelsa", "Bayelsa", "");
    addOption(document.drop_list.State, "Benue", "Benue", "");
    addOption(document.drop_list.State, "Borno", "Borno", "");
    addOption(document.drop_list.State, "Cross River", "Cross River", "");
    addOption(document.drop_list.State, "Delta", "Delta", "");
    addOption(document.drop_list.State, "Ebonyi", "Ebonyi", "");
    addOption(document.drop_list.State, "Edo", "Edo", "");
    addOption(document.drop_list.State, "Ekiti", "Ekiti", "");
    addOption(document.drop_list.State, "Enugu", "Enugu", "");
    addOption(document.drop_list.State, "F.C.T", "F.C.T", "");
    addOption(document.drop_list.State, "Gombe", "Gombe", "");
    addOption(document.drop_list.State, "Imo", "Imo", "");
    addOption(document.drop_list.State, "Jigawa", "Jigawa", "");
    addOption(document.drop_list.State, "Kaduna", "Kaduna", "");
    addOption(document.drop_list.State, "Kano", "Kano", "");
    addOption(document.drop_list.State, "Katsina", "Katsina", "");
    addOption(document.drop_list.State, "Kebbi", "Kebbi", "");
    addOption(document.drop_list.State, "Kogi", "Kogi", "");
    addOption(document.drop_list.State, "Kwara", "Kwara", "");
    addOption(document.drop_list.State, "Lagos", "Lagos", "");
    addOption(document.drop_list.State, "Nasarawa", "Nasarawa", "");
    addOption(document.drop_list.State, "Niger", "Niger", "");
    addOption(document.drop_list.State, "Ogun", "Ogun", "");
    addOption(document.drop_list.State, "Ondo", "Ondo", "");
    addOption(document.drop_list.State, "Osun", "Osun", "");
    addOption(document.drop_list.State, "Oyo", "Oyo", "");
    addOption(document.drop_list.State, "Plateau", "Plateau", "");
    addOption(document.drop_list.State, "Rivers", "Rivers", "");
    addOption(document.drop_list.State, "Sokoto", "Sokoto", "");
    addOption(document.drop_list.State, "Taraba", "Taraba", "");
    addOption(document.drop_list.State, "Yobe", "Yobe", "");
    addOption(document.drop_list.State, "Zamfara", "Zamfara", "");
}
...
//    addOption(document.drop_list.lga, "", "Region", "");

    if (document.drop_list.State.value == 'Ogun') {
        addOption(document.drop_list.lga, "0", "Choose Center");
        ...
        addOption(document.drop_list.lga, "Sagamu", "Sagamu");
        addOption(document.drop_list.lga, "Agbara", "Agbara");
        addOption(document.drop_list.lga, "Ogodu", "Ogodu");
        addOption(document.drop_list.lga, "Yewa North", "Yewa North");
        addOption(document.drop_list.lga, "Yewa South", "Yewa South");
    }
    if (document.drop_list.State.value == 'Abia') {
        ...
        addOption(document.drop_list.lga, "Isuikwuato", "Isuikwuato");
        addOption(document.drop_list.lga, "Obi Ngwa", "Obi Ngwa");
        addOption(document.drop_list.lga, "Ohafia", "Ohafia");
        addOption(document.drop_list.lga, "Osisioma Ngwa", "Osisioma Ngwa");
        ...
        addOption(document.drop_list.lga, "Umu Nneochi", "Umu Nneochi");
    }
    if (document.drop_list.State.value == 'Adamawa') {
        ...
        addOption(document.drop_list.lga, "Ganye", "Ganye");
        addOption(document.drop_list.lga, "Girei", "Girei");
    ...
    if (document.drop_list.State.value == 'Bauchi') {
          addOption(document.drop_list.lga, "0", "Choose Center");
        addOption(document.drop_list.lga, "Bauchi (Southern region)", "Bauchi (Southern region)");
        ...
        addOption(document.drop_list.lga, "Gololo", "Gololo");
        ...
        addOption(document.drop_list.lga, "Darazo (Northern region)", "Darazo (Northern region)");
        ...
        addOption(document.drop_list.lga, "Gamawa", "Gamawa");
        addOption(document.drop_list.lga, "Damban", "Damban");
    }
    if (document.drop_list.State.value == 'Bayelsa') {
        ...
        addOption(document.drop_list.lga, "Southern Ijaw", "Southern Ijaw");
        addOption(document.drop_list.lga, "Yenagoa", "Yenagoa");
    ...
    if (document.drop_list.State.value == 'Benue') {
        ...
        addOption(document.drop_list.lga, "Otukpo", "Otukpo");
    ...
    if (document.drop_list.State.value == 'Borno') {
        ...
        addOption(document.drop_list.lga, "Chibok", "Chibok");
    ...
    if (document.drop_list.State.value == 'Delta') {
        ...
        addOption(document.drop_list.lga, "Patan", "Patan");
    ...
    if (document.drop_list.State.value == 'Ebonyi') {
        ...
        addOption(document.drop_list.lga, "lkwo", "lkwo");
    ...
    if (document.drop_list.State.value == 'Edo') {
        ...
        addOption(document.drop_list.lga, "Onwa West", "Onwa West");
        addOption(document.drop_list.lga, "Onwa East", "Onwa East");
    ...
    if (document.drop_list.State.value == 'Enugu') {
        ...
        addOption(document.drop_list.lga, "IgboEze North", "IgboEze North");
    ...
    if (document.drop_list.State.value == 'F.C.T') {
          addOption(document.drop_list.lga, "0", "Choose Center");
        addOption(document.drop_list.lga, "Abaji Local Government Secretariat (Council Chambers), Off Kogi-Agbaji Expressway, Abaji", "Abaji");
        addOption(document.drop_list.lga, "AEDC Distribution Center Lugbe FHA", "AEDC Lugbe");
        addOption(document.drop_list.lga, "AMAC Secretariat, Kabusa Junction, Apo Village", "AMAC ERC");
        addOption(document.drop_list.lga, "Abuja Municipal", "Bwari ERC");
        addOption(document.drop_list.lga, "Customs Workshop, Beside Custom Clinic, Karu Site", "Customs Karu");
        addOption(document.drop_list.lga, "Dakwa", "Dakwa ERC");
        addOption(document.drop_list.lga, "Dei Dei International Building Materials Market", "Dei Dei International Market");
        addOption(document.drop_list.lga, "Zuba", "FCT College Of Education");
        addOption(document.drop_list.lga, "11 Sokode Crescent, Off Dalaba Street Zone 5, Wuse Abuja", "FCT State Office");
        addOption(document.drop_list.lga, "Federal Secretariat Phase I, Ground Floor, SGF Hall, Ahmadu Bello Way", "Federal Secretariat ERC");
    }
    ...
    if (document.drop_list.State.value == 'Imo') {
        ...
        addOption(document.drop_list.lga, "Mbaitoli", "Mbaitoli");
    ...
    if (document.drop_list.State.value == 'Jigawa') {
        ...
        addOption(document.drop_list.lga, "Biriniwa", "Biriniwa");
        ...
        addOption(document.drop_list.lga, "Kafin Hausa", "Kafin Hausa");
    ...
    if (document.drop_list.State.value == 'Kaduna') {
        ...
        addOption(document.drop_list.lga, "Jema'a", "Jema'a");
        ...
        addOption(document.drop_list.lga, "Kauru", "Kauru");
    ...
    if (document.drop_list.State.value == 'Katsina') {
        ...
        addOption(document.drop_list.lga, "Charanchi", "Charanchi");
    ...
    if (document.drop_list.State.value == 'Kebbi') {
          addOption(document.drop_list.lga, "0", "Choose Center");
        addOption(document.drop_list.lga, "Aleiro", "Aleiro");
        addOption(document.drop_list.lga, "Arewa-Dandi", "Arewa-Dandi");
        ...
        addOption(document.drop_list.lga, "Wasagu/Danko", "Wasagu/Danko");
    ...
    if (document.drop_list.State.value == 'Nasarawa') {
          addOption(document.drop_list.lga, "0", "Choose Center");
        ...
        addOption(document.drop_list.lga, "Nasarawa", "Nasarawa");
        addOption(document.drop_list.lga, "Nasarawa-Eggon", "Nasarawa-Eggon");
        addOption(document.drop_list.lga, "Obi", "Obi");
    ...
    if (document.drop_list.State.value == 'Ondo') {
        ...
        addOption(document.drop_list.lga, "Akoko South", "Akoko South");
        addOption(document.drop_list.lga, "Akure East", "Akure East");
    ...
    if (document.drop_list.State.value == 'Oyo') {
        ...
        addOption(document.drop_list.lga, "Ibarapa Central", "Ibarapa Central");
        ...
        addOption(document.drop_list.lga, "Ogbmosho South", "Ogbmosho South");
    ...
    if (document.drop_list.State.value == 'Plateau') {
          addOption(document.drop_list.lga, "0", "Choose Center");
        addOption(document.drop_list.lga, "Barikin Ladi", "Barikin Ladi");
        ...
        addOption(document.drop_list.lga, "Qua'an Pan", "Qua'an Pan");
    ...
    if (document.drop_list.State.value == 'Sokoto') {
        ...
        addOption(document.drop_list.lga, "Dange-shnsi", "Dange-shnsi");
        ...
        addOption(document.drop_list.lga, "Gawabawa", "Gawabawa");
        ...
        addOption(document.drop_list.lga, "Tqngaza", "Tqngaza");
    ...
    if (document.drop_list.State.value == 'Yobe') {
        ...
        addOption(document.drop_list.lga, "Bursari", "Bursari");
        ...
        addOption(document.drop_list.lga, "Karasuwa", "Karasuwa");
    ...
    if (document.drop_list.State.value == 'Zamfara') {
        ...
        addOption(document.drop_list.lga, "Gusau", "Gusau");
        addOption(document.drop_list.lga, "Kaura", "Kaura");
